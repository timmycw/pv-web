...
function California() {
  return (
    <div className="Body">
        <Typography variant="h3" align="center" sx={{fontWeight: "bold"}}>CALIFORNIA</Typography>
        ...
        <List sx={{ listStyleType: "none", pl: 4, '& .MuiListItem-root': {display: 'list-item'} }}>
            ...
            <ListItem>2. Complete a late vote-by-mail ballot application available  
                <a href="https://www.sos.ca.gov/elections/voter-registration/vote-mail/#late">here</a> or on our site.
                <List>
                    <ListItem>
